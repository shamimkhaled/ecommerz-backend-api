...
from accounts.views import (UserAPIView, UserLoginAPIView, UserProfileAPIView, UpdateUserProfileAPIView,
                             UserLogoutAPIView, UserRegisterationAPIView, PasswordResetRequestView,
...
urlpatterns = [
    ...
    path('profiles/update', UpdateUserProfileAPIView.as_view(), name='update-user-profile'),
